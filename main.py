...
try:
    with open("data_logger.txt", "w") as registro:
        registro.write("Fecha,Hora,Temperatura_DHT11,Humedad_DHT11,Temperatura_MAX6675,Error_MAX6675\n")
        ...
        while True:
            ...
            # Formato CSV para el archivo de log
            linea_de_datos = "{},{},{},{},{},{}\n".format(
                fecha,
                hora,
                temp_dht,
